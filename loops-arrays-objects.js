...
for (let i = 0; i < vacationDays.length; i++) {
	const remainingVacationDays = vacationDays[i].totalVacationDays - vacationDays[i].usedVacationDays;
...
for (let i = 0; i < scores.length; i++) {
	...
	} else if (scores[i].score <= 99 && scores[i].score >= 90){
		scores[i].salaryIncrease = '4%';
	} else if (scores[i].score <= 89 && scores[i].score >= 70){
		scores[i].salaryIncrease = '3%';
	} else if (scores[i].score <= 69 && scores[i].score >= 60){
